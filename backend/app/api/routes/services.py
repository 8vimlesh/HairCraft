...
async def seed_services(db = Depends(get_db)):
    ...
    male_services = [
        ...
        {"name": "Beard Cut", "category": "male", "duration_minutes": 20, "price": 150.0, "active": True},
        {"name": "Hair and Beard Cut", "category": "male", "duration_minutes": 50, "price": 450.0, "active": True},
        ...
        {"name": "Massage", "category": "male", "duration_minutes": 20, "price": 250.0, "active": True},
    ]
